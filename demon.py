    ...
    if lines_to_fit == 'all':
        for lines_to_fit in ['ha_n2', 'hb', 'o3', 's2', 'o1']:
            ...
            with mp.Pool(n_proc) as pool:
                result_list = pool.starmap(forloop, zip(
                    (xf, yf, params) for yf in np.arange(naxis2) for xf in np.arange(naxis1)))
        ...
        if lines_to_fit == 'all_cons':
            for lines_to_fit in np.array(['hb_ha_n2_cons', 'o3_cons', 's2_cons', 'o1_cons']):
                ...
                if lines_to_fit == 'hb_ha_n2_cons':
                    ...
                    params, f_res, lam_r, SN = initial_parameters.hb_ha_n2_cons(gmodel, lam, cube, SN, c, results_dir,
                                                                                aut_ini)
                    ...
                    params, f_res, lam_r, SN = initial_parameters.o3_cons(gmodel, lam, cube, SN, c, results_dir,
                                                                          aut_ini)
                    ...
                    params, f_res, lam_r, SN = initial_parameters.o1_cons(gmodel, lam, cube, SN, c, results_dir,
                                                                          aut_ini)
                    ...
                    params, f_res, lam_r, SN = initial_parameters.s2_cons(gmodel, lam, cube, SN, c, results_dir,
                                                                          aut_ini)
                ...
                if refit_flag == 'yes':
                    ...
                    print('Redoing bad fits...')
                    if lines_to_fit == 'hb_ha_n2_cons':
                        result_list = refit.hb_ha_n2_gaussians_cons(naxis1, naxis2, result_list, results_dir, lam_r,
                                                                    params, gmodel)

                    elif (lines_to_fit == 'o3_cons') | (lines_to_fit == 'o1_cons'):
                        result_list = refit.two_gaussians_cons(naxis1, naxis2, result_list, results_dir, lam_r, params,
                                                               gmodel)

                    elif lines_to_fit == 's2_cons':
                        result_list = refit.two_gaussians_cons_s2(naxis1, naxis2, result_list, results_dir, lam_r,
                                                                  params, gmodel)
                ...
                if morec_flag == 'yes':
                    ...
                    if lines_to_fit == 'o3_cons':
                        result_list, ncomps_flag, bic_flag = more_comps.two_gaussians_cons_o3(naxis1, naxis2,
                                                                                              result_list, results_dir,
                                                                                              lam_r, params)

                    elif lines_to_fit == 'o1_cons':
                        result_list, ncomps_flag, bic_flag = more_comps.two_gaussians_cons_o1(naxis1, naxis2,
                                                                                              result_list, results_dir,
                                                                                              lam_r, params)

                    elif lines_to_fit == 's2_cons':
                        result_list, ncomps_flag, bic_flag = more_comps.two_gaussians_cons_s2(naxis1, naxis2,
                                                                                              result_list, results_dir,
                                                                                              lam_r, params)

                    elif lines_to_fit == 'ha_n2_cons':
                        result_list, ncomps_flag, bic_flag = more_comps.three_gaussians_cons(naxis1, naxis2,
                                                                                             result_list, results_dir,
                                                                                             lam_r, params)

                    elif lines_to_fit == 'hb_ha_n2_cons':
                        result_list, ncomps_flag, bic_flag = more_comps.hb_ha_n2_gaussians_cons(naxis1, naxis2,
                                                                                                result_list,
                                                                                                results_dir, lam_r,
                                                                                                params)
                    ...
                    if lines_to_fit == 'o3_cons':
                        output.two_gaussians_2g_cons_o3(naxis1, naxis2, result_list, results_dir, lam_r, ncomps_flag,
                                                        bic_flag)

                    elif lines_to_fit == 'o1_cons':
                        output.two_gaussians_2g_cons_o1(naxis1, naxis2, result_list, results_dir, lam_r, ncomps_flag,
                                                        bic_flag)

                    elif lines_to_fit == 's2_cons':
                        output.two_gaussians_2g_cons_s2(naxis1, naxis2, result_list, results_dir, lam_r, ncomps_flag,
                                                        bic_flag)

                    elif lines_to_fit == 'ha_n2_cons':
                        output.three_gaussians_2g_cons(naxis1, naxis2, result_list, results_dir, lam_r, ncomps_flag,
                                                       bic_flag)

                    elif lines_to_fit == 'hb_ha_n2_cons':
                        output.hb_ha_n2_gaussians_2g_cons(naxis1, naxis2, result_list, results_dir, lam_r, ncomps_flag,
                                                          bic_flag)
            ...
            if lines_to_fit == 'ha_n2':
                ...
                params, f_res, lam_r, SN = initial_parameters.ha_n2_2g_cons(gmodel, lam, cube, SN, c, results_dir,
                                                                            aut_ini)
            ...
            if refit_flag == 'yes':
                ...
                if lines_to_fit == 'ha_n2_cons':
                    result_list = refit.three_gaussians_cons(naxis1, naxis2, result_list, results_dir, lam_r, params,
                                                             gmodel)
                    ...
                    result_list = refit.three_gaussians_2g_cons(naxis1, naxis2, result_list, results_dir, lam_r, params,
                                                                gmodel)

                elif lines_to_fit == 'hb_ha_n2_cons':
                    result_list = refit.hb_ha_n2_gaussians_cons(naxis1, naxis2, result_list, results_dir, lam_r, params,
                                                                gmodel)
                    ...
                    result_list = refit.two_gaussians_cons_s2(naxis1, naxis2, result_list, results_dir, lam_r, params,
                                                              gmodel)
            ...
            if morec_flag == 'yes':
                ...
                if lines_to_fit == 'o3_cons':
                    result_list, ncomps_flag, bic_flag = more_comps.two_gaussians_cons_o3(naxis1, naxis2, result_list,
                                                                                          results_dir, lam_r, params)

                elif lines_to_fit == 'o1_cons':
                    result_list, ncomps_flag, bic_flag = more_comps.two_gaussians_cons_o1(naxis1, naxis2, result_list,
                                                                                          results_dir, lam_r, params)

                elif lines_to_fit == 's2_cons':
                    result_list, ncomps_flag, bic_flag = more_comps.two_gaussians_cons_s2(naxis1, naxis2, result_list,
                                                                                          results_dir, lam_r, params)

                elif lines_to_fit == 'ha_n2_cons':
                    result_list, ncomps_flag, bic_flag = more_comps.three_gaussians_cons(naxis1, naxis2, result_list,
                                                                                         results_dir, lam_r, params)

                elif lines_to_fit == 'hb_ha_n2_cons':
                    result_list, ncomps_flag, bic_flag = more_comps.hb_ha_n2_gaussians_cons(naxis1, naxis2, result_list,
                                                                                            results_dir, lam_r, params)

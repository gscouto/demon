    ...
    for i in np.arange(naxis1):
        for j in np.arange(naxis2):
            ...
            if (ncomps_flag[j, i] == 1) and (bic_flag[j, i] == 2):
                ...
                model_2g_n[:, j, i] = (am[j, i] + (bm[j, i] * lam_r)) + (fluxm[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c))) * np.exp(-(lam_r - (
                            (velm[j, i] * results[j, i].params['lam01'].value / c) + results[j, i].params[
                        'lam01'].value)) ** 2 / (2 * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c) ** 2)) + ((fluxm[j, i] / 3.05) / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c))) * np.exp(-(lam_r - (
                            (velm[j, i] * results[j, i].params['lam02'].value / c) + results[j, i].params[
                        'lam02'].value)) ** 2 / (2 * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c) ** 2))

                model_2g_b[:, j, i] = (am[j, i] + (bm[j, i] * lam_r)) + (fluxm_b[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c))) * np.exp(-(lam_r - (
                            (velm_b[j, i] * results[j, i].params['lam01'].value / c) + results[j, i].params[
                        'lam01'].value)) ** 2 / (2 * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c) ** 2)) + ((fluxm_b[j, i] / 3.05) / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c))) * np.exp(-(lam_r - (
                            (velm_b[j, i] * results[j, i].params['lam02'].value / c) + results[j, i].params[
                        'lam02'].value)) ** 2 / (2 * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c) ** 2))
    ...
    for i in np.arange(naxis1):
        for j in np.arange(naxis2):
            ...
            if (ncomps_flag[j, i] == 1) and (bic_flag[j, i] == 2):
                ...
                model_2g_n[:, j, i] = (am[j, i] + (bm[j, i] * lam_r)) + ((fluxm[j, i] / 2.94) / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c))) * np.exp(-(lam_r - (
                            (velm[j, i] * results[j, i].params['lam01'].value / c) + results[j, i].params[
                        'lam01'].value)) ** 2 / (2 * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c) ** 2)) + (fluxm[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c))) * np.exp(-(lam_r - (
                            (velm[j, i] * results[j, i].params['lam02'].value / c) + results[j, i].params[
                        'lam02'].value)) ** 2 / (2 * (
                ...
                model_2g_b[:, j, i] = (am[j, i] + (bm[j, i] * lam_r)) + ((fluxm_b[j, i] / 2.94) / (
                            np.sqrt(2 * np.pi) * (
                                np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                            'lam01'].value / c))) * np.exp(-(lam_r - (
                            (velm_b[j, i] * results[j, i].params['lam01'].value / c) + results[j, i].params[
                        'lam01'].value)) ** 2 / (2 * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c) ** 2)) + (fluxm_b[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c))) * np.exp(-(lam_r - (
                            (velm_b[j, i] * results[j, i].params['lam02'].value / c) + results[j, i].params[
                        'lam02'].value)) ** 2 / (2 * (
    ...
    for i in np.arange(naxis1):
        for j in np.arange(naxis2):
            ...
            if (ncomps_flag[j, i] == 1) and (bic_flag[j, i] == 2):
                ...
                model_2g_n[:, j, i] = (am[j, i] + (bm[j, i] * lam_r)) + (fluxm1[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c))) * np.exp(-(lam_r - (
                            (velm[j, i] * results[j, i].params['lam01'].value / c) + results[j, i].params[
                        'lam01'].value)) ** 2 / (2 * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c) ** 2)) + (fluxm2[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c))) * np.exp(-(lam_r - (
                            (velm[j, i] * results[j, i].params['lam02'].value / c) + results[j, i].params[
                        'lam02'].value)) ** 2 / (2 * (
                ...
                model_2g_b[:, j, i] = (am[j, i] + (bm[j, i] * lam_r)) + (fluxm1_b[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c))) * np.exp(-(lam_r - (
                            (velm_b[j, i] * results[j, i].params['lam01'].value / c) + results[j, i].params[
                        'lam01'].value)) ** 2 / (2 * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c) ** 2)) + (fluxm2_b[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c))) * np.exp(-(lam_r - (
                            (velm_b[j, i] * results[j, i].params['lam02'].value / c) + results[j, i].params[
                        'lam02'].value)) ** 2 / (2 * (
    ...
    for i in np.arange(naxis1):
        for j in np.arange(naxis2):
            ...
            if (ncomps_flag[j, i] == 1) and (bic_flag[j, i] == 2):
                ...
                model_2g_n[:, j, i] = (am[j, i] + (bm[j, i] * lam_r)) + ((fluxm3[j, i] / 2.94) / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam01'].value / c))) * np.exp(-(lam_r - (
                            (velm[j, i] * results[j, i].params['lam01'].value / c) + results[j, i].params[
                        'lam01'].value)) ** 2 / (2 * (
                        ...
                        'lam02'].value)) ** 2 / (2 * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c) ** 2)) + (fluxm3[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam03'].value / c))) * np.exp(-(lam_r - (
                            (velm[j, i] * results[j, i].params['lam03'].value / c) + results[j, i].params[
                        'lam03'].value)) ** 2 / (2 * (
                            np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam03'].value / c) ** 2))

                model_2g_b[:, j, i] = (am[j, i] + (bm[j, i] * lam_r)) + ((fluxm3_b[j, i] / 2.94) / (
                            np.sqrt(2 * np.pi) * (
                                np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                            'lam01'].value / c))) * np.exp(-(lam_r - (
                            (velm_b[j, i] * results[j, i].params['lam01'].value / c) + results[j, i].params[
                        ...
                        'lam02'].value)) ** 2 / (2 * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam02'].value / c) ** 2)) + (fluxm3_b[j, i] / (np.sqrt(2 * np.pi) * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam03'].value / c))) * np.exp(-(lam_r - (
                            (velm_b[j, i] * results[j, i].params['lam03'].value / c) + results[j, i].params[
                        'lam03'].value)) ** 2 / (2 * (
                            np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[j, i].params[
                        'lam03'].value / c) ** 2))
...
def hb_ha_n2_gaussians_2g_cons(naxis1, naxis2, result_list, results_dir, lam_r, ncomps_flag, bic_flag):
 ...
 \
                                                       (fluxm1[j, i] / (np.sqrt(2 * np.pi) * (
                                                                   np.sqrt((sigm[j, i] ** 2) + (inst_sigma_blue ** 2)) *
                                                                   results[j, i].params[
                                                                       'lam0_hb'].value / c))) * np.exp(-(x_hb - (
                                    (velm[j, i] * results[j, i].params['lam0_hb'].value / c) + results[j, i].params[
                                'lam0_hb'].value)) ** 2 / (2 * (
                                    np.sqrt((sigm[j, i] ** 2) + (inst_sigma_blue ** 2)) * results[j, i].params[
                                'lam0_hb'].value / c) ** 2))), \
 \
                                                      ((am_ha[j, i] + (bm_ha[j, i] * x_ha)) + \
 \
                                                       ((fluxm3[j, i] / 2.94) / (np.sqrt(2 * np.pi) * (
                                                                   np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                   results[j, i].params['lam01'].value / c))) * np.exp(
                                                                  -(x_ha - ((velm[j, i] * results[j, i].params[
                                                                      'lam01'].value / c) + results[j, i].params[
                                                                                'lam01'].value)) ** 2 / (2 * (np.sqrt(
                                                                      (sigm[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                                                              results[
                                                                                                                  j, i].params[
                                                                                                                  'lam01'].value / c) ** 2)) + \
 \
                                                       (fluxm2[j, i] / (np.sqrt(2 * np.pi) * (
                                                                   np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                   results[j, i].params['lam02'].value / c))) * np.exp(
                                                                  -(x_ha - ((velm[j, i] * results[j, i].params[
                                                                      'lam02'].value / c) + results[j, i].params[
                                                                                'lam02'].value)) ** 2 / (2 * (np.sqrt(
                                                                      (sigm[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                                                              results[
                                                                                                                  j, i].params[
                                                                                                                  'lam02'].value / c) ** 2)) + \
 \
                                                       (fluxm3[j, i] / (np.sqrt(2 * np.pi) * (
                                                                   np.sqrt((sigm[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                   results[j, i].params['lam03'].value / c))) * np.exp(
                                                                  -(x_ha - ((velm[j, i] * results[j, i].params[
                                                                      'lam03'].value / c) + results[j, i].params[
                                                                                'lam03'].value)) ** 2 / (2 * (np.sqrt(
                                                                      (sigm[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                                                              results[
                                                                                                                  j, i].params[
                                                                                                                  'lam03'].value / c) ** 2)))))
 ...
 \
                                                       (fluxm1_b[j, i] / (np.sqrt(2 * np.pi) * (np.sqrt(
                                                           (sigm_b[j, i] ** 2) + (inst_sigma_blue ** 2)) *
                                                                                                results[j, i].params[
                                                                                                    'lam0_hb'].value / c))) * np.exp(
                            -(x_hb - ((velm_b[j, i] * results[j, i].params['lam0_hb'].value / c) + results[j, i].params[
                                'lam0_hb'].value)) ** 2 / (2 * (
                                        np.sqrt((sigm_b[j, i] ** 2) + (inst_sigma_blue ** 2)) * results[j, i].params[
                                    'lam0_hb'].value / c) ** 2))), \
 \
                                                      ((am_ha[j, i] + (bm_ha[j, i] * x_ha)) + \
 \
                                                       ((fluxm3_b[j, i] / 2.94) / (np.sqrt(2 * np.pi) * (np.sqrt(
                                                           (sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) * results[
                                                                                                             j, i].params[
                                                                                                             'lam01'].value / c))) * np.exp(
                                                                  -(x_ha - ((velm_b[j, i] * results[j, i].params[
                                                                      'lam01'].value / c) + results[j, i].params[
                                                                                'lam01'].value)) ** 2 / (2 * (np.sqrt(
                                                                      (sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                                                              results[
                                                                                                                  j, i].params[
                                                                                                                  'lam01'].value / c) ** 2)) + \
 \
                                                       (fluxm2_b[j, i] / (np.sqrt(2 * np.pi) * (np.sqrt(
                                                           (sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                                                results[j, i].params[
                                                                                                    'lam02'].value / c))) * np.exp(
                                                                  -(x_ha - ((velm_b[j, i] * results[j, i].params[
                                                                      'lam02'].value / c) + results[j, i].params[
                                                                                'lam02'].value)) ** 2 / (2 * (np.sqrt(
                                                                      (sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                                                              results[
                                                                                                                  ...
                                                                                                                  'lam02'].value / c) ** 2)) + \
 \
                                                       (fluxm3_b[j, i] / (np.sqrt(2 * np.pi) * (np.sqrt(
                                                           (sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) *
                                                                                                results[j, i].params[
                                                                                                    'lam03'].value / c))) * np.exp(
                                                                  -(x_ha - ((velm_b[j, i] * results[j, i].params[
                                                                      'lam03'].value / c) + results[j, i].params[
                                                                                'lam03'].value)) ** 2 / (2 * (np.sqrt(
                                                                      (sigm_b[j, i] ** 2) + (inst_sigma_red ** 2)) *
